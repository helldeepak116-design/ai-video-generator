...
const TEAM = [
  ...
  { name: 'James Chen', role: 'Head of AI Research', color: '#f472b6', bio: 'Published 30+ papers on generative image models and diffusion.' },
  { name: 'Maria Santos', role: 'VP of Engineering', color: '#34d399', bio: 'Led engineering at Midjourney and Adobe. 15 years experience.' },
...
const VALUES = [
  { icon: Target, title: 'Innovation First', desc: 'We push boundaries of what AI can create, shipping features that were impossible 2 years ago.' },
  ...
  { icon: Heart, title: 'Accessibility', desc: 'Professional image creation should be available to everyone, not just those with big budgets.' },
  { icon: Award, title: 'Quality Obsession', desc: 'We never compromise on output quality. Every pixel must be perfect.' },
  { icon: Globe, title: 'Global Impact', desc: 'Serving creators in 150+ countries across every language is our privilege and mission.' },
  { icon: Eye, title: 'Transparency', desc: 'We are open about our AI models, how data is handled, and what our technology can do.' },
]

const TIMELINE = [
  { year: '2023 Q1', event: 'ImgAI founded with $5M seed funding from a16z & YC' },
  ...
  { year: '2024 Q2', event: 'v2.0: HD support, new styles, and enhanced generation launched' },
  { year: '2024 Q4', event: '50K+ active users, 2M+ images generated globally' },
      ...
      <section style={{ padding: '5rem 1.5rem 4rem', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: 800, margin: '0 auto', textAlign: 'center', position: 'relative', zIndex: 1 }}>
          <h1 style={{ fontSize: 'clamp(2.5rem, 5vw, 4rem)', fontWeight: 900, color: 'white', marginBottom: 24 }}>
            About <span className="gradient-text">ImgAI</span>
          </h1>
          <p style={{ color: '#6d6d8a', fontSize: 18, lineHeight: 1.8, maxWidth: 600, margin: '0 auto' }}>
            We are on a mission to democratize image creation. Founded in 2023, we combine
            cutting-edge AI research with intuitive design to make professional image
            creation accessible to everyone on Earth.
          </p>
        </div>
      </section>
        ...
        <div style={{ maxWidth: 1280, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))', gap: '3rem', alignItems: 'start' }}>
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              {[
                "ImgAI was born from a simple frustration: creating quality images was too expensive, too slow, and required too many specialized skills. A talented idea should not require a $100K design budget.",
                "Our founders - AI researchers from Stanford and MIT - believed advances in generative AI could fundamentally change this. They set out to build AI that could understand creative direction and produce stunning images from plain text.",
                "Today, ImgAI serves 50,000+ creators, businesses, and enterprises worldwide, generating millions of images that power content across every major platform. We are just getting started.",
              ].map((p, i) => (
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '1.25rem' }}>
            {TEAM.map((member, i) => (
              <div key={i} className="glass card-hover" style={{ borderRadius: 20, padding: '2rem', border: '1px solid rgba(255,255,255,0.07)', textAlign: 'center' }}>
                <div style={{ width: 72, height: 72, borderRadius: '50%', background: member.color, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 22, fontWeight: 800, color: 'white', margin: '0 auto 16px', boxShadow: `0 8px 24px ${member.color}40` }}>
