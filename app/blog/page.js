...
const POSTS = [
  { title: 'The Future of AI Video Generation in 2025', excerpt: 'Explore the latest trends shaping AI video generation and how emerging technologies will transform content creation for millions of creators worldwide.', category: 'AI Trends', date: 'Jan 15, 2025', readTime: '8 min', featured: true, gradient: 'linear-gradient(135deg, #1e0660, #001a2e)', categoryColor: '#6d3bff' },
  { title: 'How to Write Perfect AI Video Prompts', excerpt: 'Master the art of prompt engineering to consistently get stunning results from AI video generators. Includes 50+ example prompts you can use today.', category: 'Tutorial', date: 'Jan 10, 2025', readTime: '6 min', gradient: 'linear-gradient(135deg, #064e3b, #0f172a)', categoryColor: '#34d399' },
  { title: '10 Ways Businesses Use AI Video to 10x ROI', excerpt: 'Real case studies of companies that transformed their marketing with AI-generated video content and saw massive returns on investment.', category: 'Business', date: 'Jan 5, 2025', readTime: '10 min', gradient: 'linear-gradient(135deg, #4c1d95, #1e1b4b)', categoryColor: '#a78bfa' },
  { title: 'VidAI v3.0: Everything That\'s New', excerpt: 'A complete breakdown of every new feature, improvement, and capability in our biggest release yet — real-time generation, new styles, and more.', category: 'Product', date: 'Dec 28, 2024', readTime: '5 min', gradient: 'linear-gradient(135deg, #1e0660, #0c4a6e)', categoryColor: '#00d4ff' },
  ...
  { title: 'From Script to Screen: Complete AI Video Workflow', excerpt: 'A step-by-step guide to creating professional videos using AI — from initial ideation and scripting through generation and final export.', category: 'Tutorial', date: 'Dec 15, 2024', readTime: '15 min', gradient: 'linear-gradient(135deg, #78350f, #1c1917)', categoryColor: '#f59e0b' },
  { title: 'AI Video vs Traditional Video Production', excerpt: 'An honest cost-benefit analysis comparing AI video generation with traditional video production pipelines for different use cases and budgets.', category: 'Business', date: 'Dec 10, 2024', readTime: '9 min', gradient: 'linear-gradient(135deg, #0c4a6e, #164e63)', categoryColor: '#38bdf8' },
  { title: 'Top 20 AI Video Prompt Templates', excerpt: 'Our most-used, highest-performing prompt templates categorized by use case: social media, marketing, YouTube, education, and more.', category: 'Tutorial', date: 'Dec 5, 2024', readTime: '7 min', gradient: 'linear-gradient(135deg, #14532d, #064e3b)', categoryColor: '#4ade80' },
  { title: 'Building a Content Empire with AI Video', excerpt: "How one creator went from zero to 2M followers in 6 months using VidAI to produce daily content across YouTube, TikTok, and Instagram.", category: 'Case Study', date: 'Nov 28, 2024', readTime: '11 min', gradient: 'linear-gradient(135deg, #701a75, #4c1d95)', categoryColor: '#e879f9' },
]
  ...
  return (
    <div style={{ paddingTop: 80 }}>
      ...
      <section style={{ padding: '5rem 1.5rem 3rem', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: 700, margin: '0 auto', textAlign: 'center', position: 'relative', zIndex: 1 }}>
          ...
          <p style={{ color: '#6d6d8a', fontSize: 18, lineHeight: 1.7 }}>
            AI video tips, tutorials, industry insights, and product updates
          </p>
        </div>
      </section>
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 1.5rem 5rem' }}>
        {/* Featured Post */}
        <div className="glass card-hover" style={{ borderRadius: 24, overflow: 'hidden', border: '1px solid rgba(255,255,255,0.08)', marginBottom: '3rem', display: 'grid', gridTemplateColumns: '1fr 1fr' }} className="blog-featured glass card-hover">
      ...
      <CTASection />
      <style>{`.blog-featured{grid-template-columns:1fr 1fr} @media(max-width:768px){.blog-featured{grid-template-columns:1fr!important}}`}</style>
    </div>
  )
}